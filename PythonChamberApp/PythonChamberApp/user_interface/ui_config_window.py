...
class UI_config_window(QWidget):
    ...
    def __init__(self):
        ...
        # build main widgets
        antrig_system_logo_widget = self.__init_antrig_logo_widget()
        ...
        main_left_layout.addSpacing(15)
        main_left_layout.addWidget(antrig_system_logo_widget, alignment=Qt.AlignmentFlag.AlignRight)
        main_left_layout.addSpacing(30)
    ...
    def __init_antrig_logo_widget(self):
        antrig_system_logo_widget = QSvgWidget()
        antrig_system_logo_widget.setFixedSize(250, 75)
        antrig_system_logo_widget.load(os.path.join(os.getcwd(), "PythonChamberApp/figures/AntRig_Logo_Large_ConfigTab.svg"))
        return antrig_system_logo_widget
